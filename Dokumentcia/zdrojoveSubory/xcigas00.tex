...
%   xcigas00-20-literatura-bibliography.bib - literatura / bibliography
%   xcigas00-01-kapitoly-chapters.tex - obsah práce / the thesis content
%   xcigas00-30-prilohy-appendices.tex - přílohy / appendices
%==============================================================================
...
\projectinfo{
  ...
  title.cs={Odhad osobnostních vlastností z videa},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Apparent Personality Analysis from Video}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Patrik Čigáš},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={Patrik},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={Čigáš},   %prijmeni autora (pro citaci) / author surname (for reference) 
...
\acknowledgment{Týmto by som sa chcel poďakovať pánovi Ing. Michalovi Hradišovi, Ph.D. za všetok venovaný čas a cenné rady, ktoré ma naviedli na riešenie tejto práce. Ďalej by som sa chcel poďakovať virtuálnej organizácií Metacentrum za poskytnuté výpočetné prostriedky, poďakovanie je uvedené nižšie v požadovanom formáte.
...
\fi
  ...
  % ----------------------------------------------
  \input{xcigas00-01-kapitoly-chapters} % viz. obsah.tex / see obsah.tex
...
\fi
  \begin{flushleft}
  \bibliography{xcigas00-20-literatura-bibliography}
  \end{flushleft}
...
\fi
  ...
  \iftwoside
    \cleardoublepage
  \fi
  \input{xcigas00-30-prilohy-appendices} % viz. prilohy.tex / see prilohy.tex
\end{document}
